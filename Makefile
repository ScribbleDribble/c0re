...
cpu/isr.o : cpu/isr.asm
	nasm cpu/isr.asm -f elf -o cpu/isr.o
# links ELF kernel_entry and kernel for direct access to main function of kernel. 
# the binary will start at address 0x1000
bin/kernel.bin : kernel/kernel.o kernel/kernel_entry.o kernel/string.o drivers/screen.o cpu/idt_load.o cpu/idt.o cpu/isr.o
	i386-elf-ld kernel/kernel.o kernel/kernel_entry.o kernel/string.o drivers/screen.o cpu/idt_load.o cpu/idt.o cpu/isr.o -Ttext 0x1000 -o bin/kernel.bin --oformat binary
