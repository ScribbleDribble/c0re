...
bin/kernel.bin : kernel/kernel.o kernel/kernel_entry.o drivers/screen.o
	i386-elf-ld kernel/kernel.o kernel/kernel_entry.o drivers/screen.o -Ttext 0x1000 -o bin/kernel.bin --oformat binary
