...
; data structure describing access to segments within memory 
...
gdt_user_code_descriptor:
	; base = 0x0 limit=0xfffff (maximise limit to conform to flat memory model - we plan on using paging)
	; 1st flags (present)1 (priviledge)00 (descriptor type)1 -> 0b1111
	; type flags (code)1 (conforming)0 (readable)1 (accessed)0 -> 0b1010
	; 2nd flags (granularity)1 (32-bit default)1 (64-bit seg) 0 (AVL) 0 -> 1100
	...
	; secon	d double word 
	db 0x0		; Base (bits 16-23 of base)
	db 11111010b	; 1st flags and type flags
	db 11001111b 	; 2nd flags, Limit (bits 16-19) 
	db 0x0		; Base (bits 24-31)
...
gdt_task_switch_segment_descriptor:
	; base = 0x0 limit=0xfffff (maximise limit to conform to flat memory model - we plan on using paging)
	; 1st flags (present)1 (priviledge)00 (descriptor type)0 -> 0b1000
	; type flags (code)1 (conforming)0 (readable)1 (accessed)0 -> 0b1000
	; 2nd flags (granularity)1 (32-bit default)1 (64-bit seg) 0 (AVL) 0 -> 1100
	...
	; second double word 
	db 0x0		; Base (bits 16-23 of base)
	db 10001001b	; 1st flags and type flags
