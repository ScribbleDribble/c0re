...
#define PHYS_BASE 0x5000000 
#define PHYS_END 0x9FFFFFF  // Set these values based on how much virtual memory is mapped and what we may need. Must be divisible by PAGE_SIZE!!
...
#define PROC_VM_COPY_PD_IDX (PROC_MM_PD_IDX+1)
...
#define SIZEOF_KERNEL_STACK 0x1000